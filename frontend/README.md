...
-   Back End - since many of features have been removed on the front end, this is also the case on the back end for the logic that supported it. The algorithms used to keep track of blockchain state and render images has also been modified.
