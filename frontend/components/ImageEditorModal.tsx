    ...
    return (
        ...
        >
            ...
            <div className="min-h-screen px-4 text-center">
                ...
                <div className="relative border-2 border-gray-600 bg-white inline-block w-full max-w-4xl p-6 sm:p-8 my-8 overflow-hidden text-left align-middle transition-all transform">
                    <Dialog.Title
                        as="h3"
                        className="title font-bold text-2xl mb-4"
                    >
                        Tile #{tile.id} Image Editor
                    </Dialog.Title>
                    <div className="mt-2">
                    ...
                    <div className="mt-4 flex justify-end">
                        <button
                            type="button"
                            className="border-2 border-red-600 p-2 px-4 bg-white text-black"
                            onClick={closeModal}
                        >
                            Cancel
                        </button>
